...
def mix_input():
    ...
    dataset1 = get_data('data/monet2photo/trainA/')
    dataset2 = get_data('data/vangogh2photo/trainA/')
    dataset3 = get_data('data/monet2photo/trainB/')

    # Combine datasets into a single dataset
    # all_datasets = ConcatDataset([folder1_dataset, folder2_dataset, folder3_dataset])
    all_datasets = ConcatDataset([dataset1, dataset2, dataset3])
